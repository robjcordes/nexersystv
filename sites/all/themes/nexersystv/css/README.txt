...
To use these stylesheets, rename the files and nexersystv with the name of your theme.
...
nexersystv-alpha-default-narrow.css  
...
nexersystv-alpha-default-normal.css
...
nexersystv-alpha-default-wide.css
