...
To use these stylesheets, rename the files and nexnewwp with the name of your theme.
...
nexnewwp-alpha-default-narrow.css  
...
nexnewwp-alpha-default-normal.css
...
nexnewwp-alpha-default-wide.css
